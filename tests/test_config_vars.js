...
describe('environment variables', function() {
    ...
    beforeEach(function() {
        process.env['key_bool'] = 'true';
        process.env['key_string'] = 'asdf';
        process.env['key_num'] = '2';
    });

    it('should throw missing var error', function () {
        delete process.env['key_string'];
        (function() {
    ...
    it('should return with boolean', function(done) {
        ...
        process.env['key_bool'] = 'sdfaglkfad';
        expect(configVars.from_environment(schema).setup.key_bool).to.be.a('boolean').and.equal(false);
        process.env['key_bool'] = '5';
        expect(configVars.from_environment(schema).setup.key_bool).to.be.a('boolean').and.equal(false);
        done()
    });
